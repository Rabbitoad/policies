...
똑비(www.ddokbi.com) 서비스(이하 "똑비")를 운영하는 ㈜토끼와두꺼비(이하 ‘회사’)는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보처리방침(이하 "방침")을 수립·공개합니다. 이 개인정보처리방침은 2024년 2월 19일부터 적용됩니다.
...
① 회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리된 개인정보는 다음 각 호의 목적 외 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 「개인정보보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.  
 ...
 2. 서비스 제공 및 관리: 회원의 신원 확인, 회원 요청 내용 확인 및 응대, 응대 결과 전달, 요금 결제 및 정산 등 ‘서비스 제공 및 관리’를 목적으로 개인정보를 처리합니다.
 3. 광고: 광고성 또는 이벤트 정보 및 참여 기회 제공, 회원의 인구통계학적 특성 또는 서비스 이용 행태에 따른 광고 게재 등을 목적으로 개인정보를 처리합니다.

# 제2조(처리 항목)
① 회사는 다음의 개인정보 항목을 처리하고 있습니다.
1. 회원가입 및 관리: 
  * 카카오톡 이용자: 휴대전화번호, 이름, 성별, 생년월일
  * 안드로이드앱 이용자: 휴대전화번호, 이름, 성별, 생년월일, 비밀번호
  * 아이폰 이용자: 휴대전화번호, 이름, 생년월일, 비밀번호
2. 서비스 제공 및 관리:
  * 카카오톡 이용자: 휴대전화번호, 이름, 성별, 생년월일, 회원-상담사 간 대화 내용, 결제 정보(카드 번호, 배송지, 수령인 등)
  * 안드로이드앱 이용자: 휴대전화번호, 이름, 성별, 생년월일, 회원-상담사 간 대화 내용, 결제 정보(카드번호, 배송지, 수령인 등)
  * 아이폰 이용자: 휴대전화번호, 이름, 생년월일, 회원-상담사 간 대화 내용, 결제 정보(카드번호, 배송지, 수령인 등)
3. 광고:
  * 카카오톡 이용자: 휴대전화번호, 성별, 생년월일
  * 안드로이드앱 이용자: 성별, 생년월일
  * 아이폰 이용자: 생년월일
4. 그 외 자동으로 처리되는 정보(안드로이드앱 이용자): 회원가입일, 하드웨어 모델, 광고식별자(부정행위 등 타 기기 로그인을 방지 위함), 운영 시스템 버전, 서비스 접속 위한 기기 세팅, 로그인 및 이용 정보(앱 통한 회원의 서비스 이용 시간, 기간, 이용 방식), 채팅 정보(채팅 시간, 채팅 입력 방식)

② 제1항의2에도 불구하고, 필요가 발생하지 않는다면 회사는 결제 정보를 회원가입 시에 미리 수집하지 않습니다.  
③ 제1항의3에도 불구하고, 카카오톡 이용자는 똑비 ‘채널 차단'을 하면 광고를 받지 않을 수 있습니다. 또한, 카카오톡 이용자 여부 불문하고, 이용자의 단말기가 제공하는 기능을 통해 푸시 알림을 끔으로서 광고를 받지 않을 수도 있습니다.  

# 제3조(보유 등 처리 기간)
① 방침 제1조의 처리 목적과 관련한 개인정보는 회원 탈퇴 후 2년까지 회사가 보유 등 처리합니다.
...
* 「신용정보의 이용 및 보호에 관한 법률」에 따른 소비자의 불만 또는 분쟁처리에 관한 기록: 3년
2. 정보주체로에게 사전에 동의를 받은 경우 : 정보주체가 사전 동의한 기간

# 제4조(개인정보의 수집 및 이용 동의 거부 시 불이익)
...
회사는 수집한 개인정보를 정보주체의 동의 없이 제3자에게 제공하지 않습니다. 정보주체의 동의를 구하였더라도, 제3자에게 개인정보를 제공할 때는 필요 최소한의 범위 내에서만 제공합니다.  
# 제6조(개인정보처리의 위탁에 관한 사항)
① 회사는 개인정보를 원활히 처리하기 위해 다음과 같이 개인정보 처리 업무를 위탁하고 있습니다.
1. 카카오톡 이용자에 대한 서비스 제공 시 상담툴(해피톡) 이용
* 위탁받는 자 (수탁자) : 엠비아이솔루션
* 위탁하는 업무의 내용 : ‘프로필봇’ 운영, 민원 사무 처리 등 서비스 제공 정보(휴대전화번호, 이름, 생년월일, 성별, 채팅 정보) 저장
* 위탁기간 : 위탁계약 종료시까지
2. 개인정보 저장 및 관리
...
* 위탁하는 업무의 내용 : 모바일 앱 이용 시 회원 대상 SMS 발송
* 위탁기간 : 위탁계약 종료시까지

② 회사는 위탁계약 체결시 「개인정보보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적/관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리/감독, 손해배상 등 책임에 관한 사항을 계약서 등에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지 감독하고 있습니다.  
③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.  

# 제7조(개인정보의 파기절차 및 방법)
① 회사는 개인정보 보유기간이 경과하였을 때에는 지체없이 해당 개인정보를 파기합니다.  
...
* 개인정보 취급 직원 최소화 및 교육: 개인정보 취급 및 관리 교육을 받은 직원을 최소한으로 유지합니다.
* 내부관리계획의 수립 및 시행: 개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다.
* 해킹 등에 대비한 기술적 대책: 회사는 해킹, 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신 또는 점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.
* 접속기록의 보관 및 위변조 방지: 개인정보처리시스템에 접속한 기록을 최소 1년 이상 보관 및 관리하고 있으며, 다만, 5만 명 이상의 정보주체에 관하여 개인정보를 추가하거나, 고유식별정보 또는 민감정보를 처리하는 경우에는 2년 이상 보관 및 관리하고 있습니다. 또한, 접속기록이 위변조 및 도난, 분실되지 않도록 보안기능을 사용하고 있습니다.
* 개인정보에 대한 접근 제한: 개인정보를 처리하는 데이터베이스시스템에 대한 접근권한의 부여, 변경, 또는 말소를 통하여 개인정보에 대한 접근통제를 위하여 필요한 조치를 하고 있으며 침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있습니다.
...
① 회원의 모바일 앱 서비스 이용 과정에서 회사는 방침 제3조제1항의4(그 외 자동으로 수집되는 정보)에 해당하는 행태정보를 처리합니다. 단, 그 처리 목적은 방침 제1조의1, 2에 해당하는 목적에 국한되며, 방침 제1조의3에 해당하는 광고 목적은 아닙니다.  
...
① 회사는 경우에 따라 정보주체의 동의 없이 개인정보를 추가적으로 이용 및 제공할 수 있습니다.  
② 제1항에도 불구하고, 회사는 ｢개인정보보호법｣ 제15조제3항, 동법 제17조제4항 등 관련 법령에서 허용하는 필요 최소한의 범위 내에서만 추가적으로 이용 및 제공합니다.  

# 제13조(가명정보 처리에 관한 사항) 
회사의 가명정보 처리 방식은 다음과 같습니다.
* 가명정보의 처리 목적: 서비스 품질 개선 및 신규 개발, 통계작성 등 「개인정보보호법」 제28조의2(가명정보의 처리 등)에서 정하는 목적
* 가명정보의 보유 등 처리 기간: 회원 탈퇴 후 2년까지
* 가명정보의 제3자 제공에 관한 사항: 「개인정보보호법」 제28조의2(가명정보의 처리 등)가 정하는 목적에 한하여 정보주체의 동의 없이 제3자에게 제공
* 가명처리하는 개인정보의 항목: 방침 제2조에서 정한 항목
...
# 제17조(개인정보 처리방침 변경)
① 이 개인정보처리방침은 2024년 2월 19일부터 적용됩니다.  
② 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다. 
* 1차 : (2023. 3. 15. ~ 2024. 2. 18.) https://www.notion.so/rabbitoad/1-f5784c7ce6ec45f89eb22faa5bade37d?pvs=4